...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Movies</h3><br />
    <asp:GridView ID="GridView1" runat="server"  CellPadding="5" GridLines="None" Font-Size="18px" BorderColor="White" BorderWidth="30px" CellSpacing="5" AutoGenerateColumns="False" HorizontalAlign="Center" style="margin-left: 193px">
        <Columns>
