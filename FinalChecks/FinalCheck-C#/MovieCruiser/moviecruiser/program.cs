...
namespace moviecruiser
{
    class Program
    {
        static void Main()
        {
            ...
            {
                {1,new Customer(1,"Vyshnavi") },
                {2,new Customer(2,"Sinha") },
                {3,new Customer(3,"Gowthami") },
                {4,new Customer(4,"Sowmya") },
                {5,new Customer(5,"Mahendra") }
            };
            Console.WriteLine("Welcome to Movie Cruiser");
            Console.WriteLine("Enter 1 to login as admin else Enter 2 for customer");
            int userType = Convert.ToByte(Console.ReadLine());
            try
            {
                if (userType == 1)
                {
                    ...
                    if ((admin.AdminName == "akshitha") && (admin.AdminPassword == "sinha"))
                    {
                        int flag = 1;
                        ...
                        while (flag == 1)
                        {
                            ...
                            int adminChoice = Convert.ToByte(Console.ReadLine());
                            if (adminChoice == 1)
                            {
